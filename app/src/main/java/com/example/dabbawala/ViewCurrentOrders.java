        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                        ...
                        switch (which) {
                            case DialogInterface.BUTTON_POSITIVE:
                                mDatabaseReference.child(Constants.booking_details).
                                        child(lstHotelsID.get(position)).child("status").setValue("Accepted");
                             JSONObject jsonObject=new JSONObject();
                                try {
                                    jsonObject.put("msg","Your request has been accepted");
                                    jsonObject.put("orderid",lstHotelsID.get(position));
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                }
                                String params[]={lstUserToken.get(position),jsonObject.toString()};
                               SENDFCM sendfcm=new SENDFCM();
                               sendfcm.execute(params);
                ...
                builder.setMessage("What do you want?")
                        .setPositiveButton("Accept Request", dialogClickListener)
                        .setNegativeButton("Cancel Request", dialogClickListener)
